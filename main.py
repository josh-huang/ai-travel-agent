...
graph_builder.add_node("analyze_reddit_post", analyze_reddit_post)
...
graph_builder.add_edge("google_search", "analyze_reddit_post")
graph_builder.add_edge("bing_search", "analyze_reddit_post")
graph_builder.add_edge("reddit_search", "analyze_reddit_post")
graph_builder.add_edge("analyze_reddit_post", "retrieve_reddit_post")
...
def run_chatbot():
    print("Multi-Source Research Chatbot")
    ...
    while True:
        ...
        print("Launching searches on Google, Bing, and Reddit...\n")
